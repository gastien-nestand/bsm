...
// This file will be implemented when Stripe integration is added
// The Express import causes build errors since Express is not in package.json
...
export const stripeWebhookDisabled = true;
